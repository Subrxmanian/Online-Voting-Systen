            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              ...
              <!--  <li class="nav-item" >
               ...
               <!-- <li class="nav-item" >
                ...
                <li class="nav-item">
                  <a class="nav-link" href="registration.php" style="color: white; font-weight: 600; text-align: center; font-size: 18px; margin-top: 20px;  text-transform: capitalize; padding: 20px;">Register</a>
                </li>
                <li class="nav-item">
