...
<div class="container">
         ...
         <div class="row">
           ...
           <p class="text-center" style="margin-bottom: 10px;">II Year Candidates </p>
         </div>
         <?php 
...
?>
        <!-- Card Start -->
          <div class="col-md-3 " style=" margin-left:25px; padding-top: 5px;">
                <div class="card" style="width: 18rem;">
                  <img class="card-img-top" src="img/9.svg" alt="shinzo" height="250px">
                  <div class="card-body">
